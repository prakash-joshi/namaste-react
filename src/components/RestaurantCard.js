...
const RestaurantCard = (props) => {
    ...
    return (
        <div data-testid="restaurantCard" id={id} className="m-4 p-4 w-[350px] h-[auto] rounded-lg bg-gray-100 hover:bg-gray-200">
            <img className="rounded-lg w-[340px] h-[225px]" src={CORS_PROXY + CDN_URL + cloudinaryImageId} ></img>
